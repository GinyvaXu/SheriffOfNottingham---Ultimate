...
_NAMES_EN = {
    ...
    'BREAD': 'Enchanted Loaf',
    'CHEESE': 'Moon Cheese',
    'CHICKEN': 'Familiar Chicken',
    'COFFEE': "Witch's Brew",
    'CROSSBOW': 'Arcane Crossbow',
    'ROYAL_BLUE_CHEESE': 'Astral Blue',
    'ROYAL_CHICKEN': 'Phoenix Chicken',
    'ROYAL_COARSE_BREAD': "Giant's Bread",
    'ROYAL_GOLD_APPLE': 'Golden Apple',
    'ROYAL_GOUDA_CHEESE': 'Archmage Cheese',
    'ROYAL_GREEN_APPLE': 'Dragon Apple',
...
_NAMES_ZH = {
    ...
    'ROYAL_CHICKEN': '凤凰鸡',
    'ROYAL_COARSE_BREAD': '巨人粗粮',
    'ROYAL_GOLD_APPLE': '黄金苹果',
    'ROYAL_GOUDA_CHEESE': '大法师奶酪',
    'ROYAL_GREEN_APPLE': '龙鳞苹果',
